...
echo "https://glue.eu-central-1.amazonaws.com" >> $glue_endpoint_file

ASSETS=s3://aws-glue-jes-prod-eu-central-1-assets/sagemaker/assets/

# Confusing for core.fn.Sub.
...
# Left out due to substitution problems
# ensure SageMaker notebook has permission for the dev endpoint
# aws glue get-dev-endpoint --endpoint-name aws-glue-dev-endpoint-063209 --endpoint https://glue.eu-central-1.amazonaws.com
